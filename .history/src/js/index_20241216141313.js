...
const continueAnimation = () => {
    ...
    if(mainWebGL) mainWebGL.classList.add("openList"); // 淡出 main-webgl
    ...
    if (isMobile) {
        ...
        document.querySelectorAll(".detail-box").forEach((box) => {
            box.addEventListener("click", async (event) => {
                ...
                // Function: 生成圖片與描述的 HTML
                async function generateImageHTML(eventData) {
                    let imageHTML = "";
                ...
                const imageHTML = generateImageHTML(eventData);
                ...
                // 導向到新頁面
                window.location.href = url || blobUrl; // 如果 data-url 有值，優先導向該連結
            });
        });
