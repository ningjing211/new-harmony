...
function generateVideoCards(eventData) {
    return eventData.additionalVideos.map((video, index) => `
        <div id="video-${eventData.folderName}-${index}" class="video-container">
            <iframe 
...
// Helper Function: 從影片 URL 提取 YouTube Video ID
