...
window.addEventListener("click", (event) => {
    ...
    if (isMobile) {
        ...
        document.documentElement.style.background = "#597d50";
        document.body.style.background = "#597d50";
...
function generateImageCards(eventData) {
    return eventData.additionalImages.map((img, index) => `
        <a id="image-${eventData.folderName}-${index}" class="logo-image">
            <img src="http://localhost:3000${img.path}" />
        </a>
...
function generateMobilePage(eventName, eventData) {
    ...
    <head>
        ...
        <style>
            html { background: #567b51; }
            body { background: #567b51; font-family: 'Noto Sans TC'; sans-serif; margin: 0; padding: 0; }
